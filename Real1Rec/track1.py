...
def apply_border(img, phrases):
    ...
    for i in range(3):
        ...
        if i < 2:
            ...
            x_end = frame_width - 2  # Last section stops at the end
    ...
    try:
        ...
        while True:
            ...
            if car_contour is None:
                display_frame = apply_border(display_frame, lap_info_phrases())
            ...
            if img is not None:
                ...
                img = apply_border(img, lap_info_phrases())
